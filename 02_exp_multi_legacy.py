...
PROMPT_STYLE = "old"  # "sml" 或 "lib"
VECTOR_DIR = REWRITE_PATH + REWRITE_MODEL.replace("/", "_") + f"/vectors_50_{PROMPT_STYLE}/" + APPLIED_MODEL.replace("/", "_")

TASKS = "gsm8k_cot_zeroshot" #"gsm8k_cot_zeroshot_unified" # "hendrycks_math_500,AIME,AMC" #"gsm8k_cot_zeroshot"
BASE_OUTDIR = Path("/common/users/sl2148/Public/yang_ouyang/projects/lm-evaluation-harness/lm_eval/models/eval_grid_less_tokens_3B_lib_manual_same_lib_1000samples") / TASKS.replace(",", "_").replace(" ", "_")
# 2. 设置生成参数
...
STEP = 1
STEER_LAMBDAS = [i * STEP for i in range(-15, 16)]  # -1.0..1.0
# 或者保留两位，保证打印一致
...
MODEL_TO_LAYERS = {
    ...
    "Qwen/Qwen2.5-3B-Instruct":   [8, 10, 17, 24, 31, 35],
